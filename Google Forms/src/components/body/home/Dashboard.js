...
function Dashboard() {
  ...
  // console.log("I am from dashboard checking for user id",user._id)
  // React.useEffect(() => {
  ...
  const createForm = () => {
    ...
    console.log("This is the bloody data",data)
    if (data.name !== "") {
      formService.createForm(data).then(
        (result) => {
          console.log("This is me your result",result);
      ...
      <AppBar position="static" style={{height:"40px"}}>
        <Toolbar style={{height:"40px"}}>          
          ...
          <div className={classes.sectionDesktop}>
            ...
            >
              <AddIcon />
              <p style={{ fontSize: "15px" }}>Create new form</p>
            </IconButton>
